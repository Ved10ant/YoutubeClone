    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-6xl">
                {/* My Video */}
                {stream && (
                    <div className="p-2 border rounded-lg bg-white shadow-md relative group">
                ...
                {callAccepted && !callEnded && (
                    <div className="p-2 border rounded-lg bg-white shadow-md relative">
            ...
            {/* Controls */}
            <div className="mt-8 bg-white p-6 rounded-xl shadow-lg w-full max-w-lg">
                <div className="flex flex-col gap-4">
                    <div className="flex gap-2">
                        ...
                        />
                        <div className="flex items-center bg-gray-100 px-3 rounded text-sm text-gray-500">
                            ID: {me}
                        </div>
