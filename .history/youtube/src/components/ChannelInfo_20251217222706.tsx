...
const ChannelInfo = () => {
  ...
  const isVideoPage = (router.pathname.includes('/watch/') || router.pathname.includes('/WatchVideo/')) && id;
  const video = isVideoPage ? ALL_VIDEOS.find((v) => String(v._id) === String(id)) : undefined;
