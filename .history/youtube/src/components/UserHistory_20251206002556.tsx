...
const UserHistory = () => {
  ...
  const [historyState, setHistoryState] = useState<HistoryItems[]>([]);
  ...
  const handleRemoveFromHistory = (historyId: string) => {
    setHistoryState(historyState.filter((item) => item._id !== historyId));
  };
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-600">{historyState.length} videos</p>
      <div className="space-y-4">
