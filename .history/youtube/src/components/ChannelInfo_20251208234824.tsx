...
const ChannelInfo = ({ channel, user }: any) => {
  ...
  return (
    <div>
      ...
      <Avatar>
        {/* The problem is likely that 'channel' is undefined or not properly passed as a prop, 
            or 'username' is missing. This causes a runtime error or renders nothing.
            Fix: add a fallback for safety. */}
        <AvatarFallback>
